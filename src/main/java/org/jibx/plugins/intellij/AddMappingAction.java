...
public class AddMappingAction extends AnAction {
    ...
    public void actionPerformed(AnActionEvent event) {
        ...
        if (psiBinding == null || psiBinding.getVirtualFile() == null)
            return;
        module.getComponent(BindingCompilerModuleComponent.class).addBinding(psiBinding.getVirtualFile());
        logger.info("Added JiBX binding: " + psiBinding.getVirtualFile().getPath());
    }
}
